    ...
    <SafeAreaView style={style.container}>
      <View style={{flexDirection: 'row'}}>
        ...
        <Pressable
          ...
          <FontAwesome6 name="circle-arrow-left" size={35} color={gStyles.azul[500]} />
        </Pressable>
      </View>
      ...
      <View style={style.view1}>
        ...
        <InputIcon style={{width:185}} placeholder="Digite seu Email" value={email} onChangeText={setEmail}>
          <FontAwesome name="envelope" size={17} color={gStyles.azul[500]} />
        </InputIcon>

        <InputSenha style={{width:163}} placeholder="Digite sua Senha" value={senha} onChangeText={setSenha}>
        ...
        >
          <Checkbox value={checked} onValueChange={setChecked} color={checked ? "#2563eb" : undefined} />
        ...
        <TextButton
          ...
          title="Login"
          onPress={logar}  
          style={{width: "55%", height: "15%", justifyContent: "center", backgroundColor: "#2563eb"}}
        />
