...
import { FilterModalProps, FiltrosState } from "../types";
      ...
      >
        ...
        <View style={style.header}>
          ...
          <View style={style.headerRight}>
            <Text style={style.clearText} onPress={limparTodosFiltros}>
              Limpar filtros
            </Text>
            <IconButton
              icon="close"
          ...
          {escopo === "artista" || escopo === "usuario" ? (
            <View>
              ...
              <TextInput
                ...
                value={filtros.nome}
                onChangeText={(txt) =>
                  modificarCampoObjeto(setFiltros, "nome", txt)
                }
              />
              ...
              <TextInput
                ...
                onChangeText={(txt) =>
                  modificarCampoObjeto(setFiltros, "cidade", txt)
                }
              />
              ...
              <TextInput
                ...
                onChangeText={(txt) =>
                  modificarCampoObjeto(setFiltros, "estado", txt)
                }
              />
              ...
              <View style={style.row}>
                <Button
                  ...
                  buttonColor={
                    filtros.tipoUsuario === "ARTISTA" ? "#E8EAF6" : undefined
                  }
                  textColor={
                    filtros.tipoUsuario === "ARTISTA" ? "#0B31A3" : "#666"
                  }
                  onPress={() =>
                    modificarCampoObjeto(setFiltros, "tipoUsuario", "ARTISTA")
                  }
                >
                  Artista
                </Button>
                ...
                <Button
                  mode={
                    filtros.tipoUsuario === "CONTRATANTE"
                      ? "contained-tonal"
                      : "outlined"
                  }
                  compact
                  ...
                  textColor={
                    filtros.tipoUsuario === "CONTRATANTE" ? "#0B31A3" : "#666"
                  }
                  onPress={() =>
                    modificarCampoObjeto(
                      setFiltros,
                      "tipoUsuario",
                      "CONTRATANTE",
                    )
            ...
            <View>
              ...
              <TextInput
                ...
                onChangeText={(txt) =>
                  modificarCampoObjeto(setFiltros, "legenda", txt)
                }
              />
              ...
              <TextInput
                ...
                onChangeText={(txt) =>
                  modificarCampoObjeto(setFiltros, "nomeAutor", txt)
                }
              />
              <View style={style.row}>
